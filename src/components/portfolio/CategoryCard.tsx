...
const CategoryCard = (props: Props) => {
    ...
    return (
        <div className='w-p32 py-vh2 flex flex-col justify-between items-center gap-vh2  bg-primary_light1 rounded-xl hover:bg-primary hover:text-white transition-all duration-500' onClick={() => props.onClickAction(props.title)}>
